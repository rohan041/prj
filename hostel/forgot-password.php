...
{ ?>
					<p class="text-center text-light">Your Password is <u><?php echo $pwd;?></u><br> Change the Password After login</p>
					<?php }  ?>

							<form action="" class="box" method="post">
								<label for="" class="text-uppercase text-light text-sm">Your Email</label>
								<input type="email" placeholder="Email" name="email" class="form-control mb">
								<label for="" class="text-uppercase text-light text-sm">Your Contact no</label>
