...
$fees=$_POST['fees'];
$id=$_GET['id'];
$query="update rooms set hostel_name=?, seater=?,fees=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiii',$hostel_name,$seater,$fees,$id);
$stmt->execute();
	   ...
	   while($row=$res->fetch_object())
	  {
	  	?>
	  		<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" name="hostel_name" id="hostel_name" value="<?php echo $row->hostel_name;?>" disabled>
