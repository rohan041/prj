...
{
$query="insert into  rooms (hostel_name,seater,room_no,fees) values(?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('siii' ,$hostel_name,$seater,$roomno,$fees);
$stmt->execute();
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title text-light">Add a Room </h2>
...
<?php } ?>
			...
			<label class="col-sm-2 control-label">Select Hostel Name  </label>
			<div class="col-sm-8">
...
<div class="form-group">
    ...
    <option value="2">3 Seater</option>
    <option value="3">4 Seater</option>
    <option value="4">5 Seater</option>
...
<div class="col-sm-8">
<input type="text" class="form-control" name="rmno" id="rmno" placeholder="room_no" value="" required="required">
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Fee(Per Student)</label>
<div class="col-sm-8">
<input type="text" class="form-control" name="fee" id="fee" placeholder="fee" value="" required="required">
</div>
</div>
