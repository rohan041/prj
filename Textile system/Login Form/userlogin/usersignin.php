<?php
include("db.php");
$valid=$emailErr=$nameErr=$phoneErr=$cpasswordErr='';
 ...
 if(isset($_POST['regi']))
 {
  ...
  if(empty($name))
	...
	{
      $nameErr="Digits AND space are not allowed";
	}
	else
	{
      $nameErr=true;
	...
	$sqll = "SELECT phone FROM userreg WHERE phone='{$phone}'";
	...
	{
     $cpasswordErr="Confirm Password doest Matched";
    }
    else
	{
     $cpasswordErr=true;
    }
	if($nameErr==true && $phoneErr==true && $emailErr==true && $cpasswordErr==true){
    $valid="success";
  $query = "INSERT INTO userreg(name,phone,email,password,type)values('$name','$phone','$email','$password','$type')"; 
    $result = mysqli_query($conn,$query) or die(mysqli_error($conn));
	   $to = $email;
            $subject = "Textile-Admin";
            $txt = "<b>Hello!</b> ".$name." your form submitted successfully!! We will Mail you soon.
<html lang='en' >
<head>
  <meta charset='UTF-8'>
                        ...
                        <td>
                            <table width='95%' border='0' align='center' cellpadding='0' cellspacing='0'
                                ...
                                <tr>
                                    ...
                                    <center><img src='https://tyjxxt.stripocdn.email/content/guids/CABINET_f447279c63e2e4946c61f7fbba573463/images/sewingmachine.png' alt='Sewing Machine Png Image - Sewing Machine Clipart, Transparent Png - kindpng' jsname='HiaYvf' jsaction='load:XAeZkd;' class='n3VNCb' data-noaft='1' style='width: 100px;height: 100px;margin: 0px;'>
                          </center>
                                        ...
                                        <p style='font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;'>
                                            Your account has been created on the online textile portal. <br><strong>💕</strong></p>
                                        <span
                                            style='display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;'></span>
                                        <p
                                            style='color:#455056; font-size:18px;line-height:20px; margin:0; font-weight: 500;'>
                                            <strong
                                                style='display: block;font-size: 13px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;'>Username</strong>Login With Your Email and password
                                            <strong
                                                style='display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);'>Password</strong>Login With Your Email and password
                                        </p>

                                        <a href='http://localhost/Textile%20system/Login%20Form/userlogin/userlogin.php'
                                            style='background: #1572e8;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;'>Login
                                            to your Account</a>
                                    </td>
                                </tr>
                                <tr>
...
<style type="text/css">
  .st0{opacity:0.2;fill:#4b70e2;}
  .st1{opacity:0.2;fill:#4b70e2;}
  .st2{opacity:0.2;fill:#4b70e2;}
  .st3{opacity:0.2;fill:#4b70e2;}
  .st4{opacity:0.2;fill:#4b70e2;}
  .st5{opacity:0.2;fill:#4b70e2;}
  .st6{opacity:0.5;fill:#4b70e2;}
  .st7{opacity:0.5;fill:#4b70e2;}
  .st8{opacity:0.2;fill:none;stroke:#4b70e2;stroke-miterlimit:10;}
  .st9{opacity:0.2;fill:#4b70e2;}
  .st10{opacity:0.2;fill:#4b70e2;}
  .st11{opacity:0.2;fill:#4b70e2;}
  .st12{opacity:0.2;fill:#4b70e2;}
  .st13{opacity:0.2;fill:#4b70e2;}
  .st14{opacity:0.5;fill:#4b70e2;}
  .st15{opacity:0.5;fill:#4b70e2;}
  .st16{opacity:0.5;fill:#4b70e2;}
  .st17{opacity:0.5;fill:#4b70e2;}
  .st18{opacity:0.5;fill:#4b70e2;}
  .st19{opacity:0.5;fill:#4b70e2;}
  .st20{opacity:0.5;fill:#4b70e2;}
  .st21{opacity:0.5;fill:#4b70e2;}
  .st22{opacity:0.5;fill:#4b70e2;}
  .st23{opacity:0.5;fill:#4b70e2;}
  .st24{opacity:0.5;fill:#4b70e2;}
  .st25{opacity:0.5;fill:#4b70e2;}
  .st26{opacity:0.5;fill:#4b70e2;}
  .st27{opacity:0.2;fill:#4b70e2;}
  .st28{opacity:5.000000e-02;fill:none;stroke:#4b70e2;stroke-miterlimit:10;}
  .st29{opacity:0.5;fill:#4b70e2;}
  .st30{opacity:0.5;fill:#4b70e2;}
  .st31{opacity:0.5;fill:#4b70e2;}
  .st32{opacity:0.5;fill:#4b70e2;}
  .st33{opacity:0.5;fill:#4b70e2;}
    .st0{opacity:0.5;fill:#4b70e2;} .st1{opacity:0.5;fill:#4b70e2;} .st2{opacity:0.5;fill:#4b70e2;} .st3{opacity:0.5;fill:#4b70e2;} .st4{opacity:0.5;fill:#4b70e2;} .st5{opacity:0.5;fill:#4b70e2;} .st6{opacity:0.5;fill:#4b70e2;} .st7{opacity:0.5;fill:#4b70e2;} .st8{opacity:0.5;fill:#4b70e2;} .st9{opacity:0.5;fill:#4b70e2;} .st10{opacity:0.5;fill:#4b70e2;} .st11{opacity:0.5;fill:#4b70e2;} .st12{opacity:0.5;fill:#4b70e2;} .st13{opacity:0.3;fill:#4b70e2;} .st14{opacity:0.3;fill:#4b70e2;} .st15{opacity:0.3;fill:#4b70e2;} .st16{opacity:0.5;fill:#4b70e2;} .st17{opacity:0.5;fill:#4b70e2;} .st18{opacity:0.5;fill:#4b70e2;} .st19{opacity:0.5;fill:#4b70e2;} .st20{opacity:0.5;fill:#4b70e2;} .st21{opacity:0.5;fill:#4b70e2;} .st22{opacity:0.5;fill:#4b70e2;} .st23{opacity:0.3;fill:#4b70e2;} .st24{opacity:0.3;fill:#4b70e2;} .st25{opacity:0.3;fill:#4b70e2;} .st26{opacity:0.3;fill:#4b70e2;} .st27{opacity:0.3;fill:#4b70e2;} .st28{opacity:0.3;fill:#4b70e2;} .st29{opacity:0.3;fill:#4b70e2;} .st30{opacity:0.3;fill:#4b70e2;} .st31{opacity:0.5;fill:#4b70e2;} .st32{opacity:0.5;fill:#4b70e2;} .st33{opacity:0.3;fill:none;stroke:#4b70e2;stroke-miterlimit:10;} .st34{opacity:5.000000e-02;fill:none;stroke:#4b70e2;stroke-miterlimit:10;} .st35{opacity:0.3;fill:#4b70e2;} .st36{opacity:0.3;fill:#4b70e2;} .st37{opacity:0.3;fill:#4b70e2;} .st38{opacity:0.3;fill:#4b70e2;} .st39{opacity:0.3;fill:#4b70e2;} .st40{opacity:0.35;fill:#4b70e2;} .st41{opacity:0.3;fill:#4b70e2;} .st42{opacity:0.3;fill:#4b70e2;} .st43{opacity:0.34;fill:#4b70e2;} .st44{opacity:0.5;fill:#4b70e2;} .st45{opacity:0.35;fill:none;stroke:#4b70e2;stroke-miterlimit:10;} .st46{opacity:0.5;fill:#4b70e2;} .st47{opacity:0.3;fill:#4b70e2;} .st48{opacity:0.3;fill:#4b70e2;} .st49{opacity:0.5;fill:#4b70e2;} .st50{opacity:0.35;fill:#4b70e2;} .st51{opacity:0.33;fill:none;stroke:#4b70e2;stroke-miterlimit:10;} .st52{opacity:0.3;fill:#4b70e2;} .st53{opacity:0.3;fill:#4b70e2;} .st54{opacity:0.3;fill:#4b70e2;} .st55{opacity:0.3;fill:#4b70e2;} .st56{opacity:0.5;fill: #4b70e2;} .st57{opacity:0.35;fill:#4b70e2;} .st58{opacity:0.34;fill:#4b70e2;} .st59{opacity:0.37;fill:#4b70e2;}
  </style>
...
<html lang="es" dir="ltr">
  ...
  <body>
    <div class="main">
      <div class="container a-container" id="a-container">
        ...
        <form class="form" id="a-form" method="POST" action="usersignin.php">
          <h2 class="form_title title">Create Account</h2>
          <span class="form__span">Registration Form</span>
          <input class="form__input" type="text" name="name" placeholder="Name" required="true"><p class="err-msg">
                  <?php if($nameErr!=1){ echo $nameErr; }?>
                </p>
          <input class="form__input" type="text" name="phone" placeholder="Phone no" required="true" pattern=".{10,}" maxlength="10"><p class="err-msg">
                  <?php if($phoneErr!=1){ echo $phoneErr; }?>
                </p>
          <input class="form__input" type="email" name="email" placeholder="Email" required="true">
		  <p class="err-msg">
                  <?php if($emailErr!=1){ echo $emailErr; }?>
                </p>
          <input class="form__input" type="password" name="password" placeholder="Password" required="true">
          <input class="form__input" type="password" name="cpassword" placeholder="Confirm Password" required="true">
		  <p class="err-msg">
         ...
         <button type="submit" name="regi" style="width: 180px;
  height: 50px;
  border-radius: 25px;
  margin-top: 50px;
  font-weight: 700;
  ...
  color: #f9f9f9;
  box-shadow: 8px 8px 16px #4B70E2, -8px -8px 16px #f9f9f9;
  border: none;
  outline: none;"><center>SIGN IN</center></button>
        </form>
      ...
      <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container" id="switch-c1">
          <h2 class="switch__title title">Welcome Back !
          <p class="switch__description description">To keep connected with us please login with your personal info</p></h2>
