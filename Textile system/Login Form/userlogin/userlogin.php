...
<html lang="es" dir="ltr">
  ...
  <body>
    <div class="main">
      <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="POST" action="userlog.php">
  ...
  border: none;
  outline: none;"><center>SIGN IN</center> </button><br><br><br>
   <a href="/Textile system/Forgot Password/fpwd.php"> Forget Password ?? </a>
        </form>
      ...
      <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container" id="switch-c1">
          <h2 class="switch__title title">Hello User</h2>
