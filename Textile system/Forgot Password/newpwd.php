...
<!-- partial -->
  ...
  if(isset($_POST['login'])){
        ...
        $cpass=$_POST['cpass'];
        if ($new == $cpass) {
        $update = mysqli_query($con,"update userreg set password = '$cpass' where email = '".$_SESSION['email']."'");
        
          echo '<script>alert("success")</script>';
          echo "<script>setTimeout(\"location.href='../Login Form/userlogin/userlogin.php'\",1500)</script>";
        }
        else
        {
           echo '<script>alert("Not Match both password!")</script>';
        }
  ...
  <body>
    <div class="main">
      <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="post" action="newpwd.php">
          <h2 class="form_title title">Create New Password</h2>
          <span class="form__span"></span>
          <input class="form__input" type="password" name="new" placeholder="New Password">
          <input class="form__input" type="password" name="cpass" placeholder="Confirm Password">

         <button type="submit" name="login" style="width: 180px;
  height: 50px;
  border-radius: 25px;
  margin-top: 50px;
  font-weight: 700;
  ...
  outline: none;"><center>SIGN IN</center></button>
      ...
      <div class="container b-container" id="b-container">
        <form class="form" id="b-form" method="" action="">
          ...
          <a class="form_link" href="#" style="color: #707070;">Forgot your password?</a>
      ...
      <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container" id="switch-c1">
          <h2 class="switch__title title">Create New Password !</h2>
