...
<html lang="es" dir="ltr">
  ...
  <body>
     <?php
        ...
        $sql=mysqli_query($con,"SELECT * FROM userreg where email='".$email."'");
        $row=mysqli_fetch_assoc($sql);
        if ($row['phone']==$phoneno) {
        $_SESSION['email'] = $email;
          echo '<script>alert("success")</script>';
          echo "<script>setTimeout(\"location.href='newpwd.php'\",1500)</script>";
        }
        else
        {
    ...
    <div class="main">
      <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="post" action="fpwd.php">
          ...
          <input class="form__input" type="text" placeholder="Phone no" name="phoneno" required>
  ...
  outline: none;"><center>SIGN IN</center></button>
      ...
      <div class="container b-container" id="b-container">
        <form class="form" id="b-form" method="" action="">
          ...
          <input class="form__input" type="text" name="" placeholder="Email">
      ...
      <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container" id="switch-c1">
          <h2 class="switch__title title">Forgot Your Password !</h2>
