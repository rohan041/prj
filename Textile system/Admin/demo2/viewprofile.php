        ...
        <section class="main">
            ...
            <div class="side_Right">
                ...
                <div class="areaBox experience">
					...
					<?php echo '<a href="confirm.php?id='.$id.'"><button type="submit" name="confirm" class="button">Confirm</button></a>
					<a href="reject.php?id='.$id.'"><button type="submit" name="reject" class="button1">Reject</button></a>'?>
