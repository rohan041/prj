					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="true">
								<div class="avatar-sm"> 
									<img src="assets/img/nvm.jpg" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="assets/img/nvm.jpg" alt="image profile" class="avatar-img rounded"></div>

											<div class="u-text">
												<!-- <h4><b>Rohan Padasala</b></h4>
												<p class="text-muted">hello@example.com</p> --><a href="/Textile system/Admin/demo2/viewadminprofile.php" class="btn btn-xs btn-secondary btn-sm">View Profile </a><div class="dropdown-divider"></div>
<p class="text-muted"></p><a href="/Textile system/Admin/demo2/myprofile.php" class="btn btn-xs btn-primary btn-sm">Edit Profile</a>
...
<li <?=($sidebar == "leav") ? 'class="nav-item nav-item-activ"' : 'class="nav-item"' ; ?>>
							...
							<div  class="collapse" id="tables">
								<ul class="nav nav-collapse">
									<li>
										<a href="/Textile system/Admin/demo2/leavemanage.php">
											<span class="sub-item">Manage Leaves</span>
										</a>
									</li>
									<li>
										<a href="/Textile system/Admin/demo2/leavehist.php">
											<span class="sub-item">Leave History</span>
										</a>
									</li>
								</ul>
							</div></li>
						...
						<li <?=($sidebar == "rpt") ? 'class="nav-item nav-item-activ"' : 'class="nav-item"' ; ?> >
...
fas fa-signal"></i>
							...
							<div class="collapse" id="maps">
								<ul class="nav nav-collapse">
									<li>
										<a href="/Textile system/Admin/demo2/stockrpt.php">
											<span class="sub-item">Daily Work Report</span>
										</a>
									</li>
									<li>
										<a href="/Textile system/Admin/demo2/expensereport.php">
											<span class="sub-item">Expense Report</span>
										</a>
									</li>
									<!-- <li>
										<a href="/Textile system/Admin/demo2/staffreport.php">
											<span class="sub-item">Staff Report</span>
										</a>
									</li> -->
								</ul>
								<li <?=($sidebar == "loc") ? 'class="nav-item nav-item-activ"' : 'class="nav-item"' ; ?> >
							<a  href="/Textile system/Admin/demo2/index.php">
